...
import numpy as np
# import depth
from .depth.resnet_encoder import *
from .depth.depth_decoder import *
...
def animate(config, generator, kp_detector, checkpoint, log_dir, dataset,opt):
    ...
    depth_encoder = ResnetEncoder(18, False).cuda()
    depth_decoder = DepthDecoder(num_ch_enc=depth_encoder.num_ch_enc, scales=range(4)).cuda()
