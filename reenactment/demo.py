...
if __name__ == "__main__":
    ...
    loaded_dict_enc = torch.load('depth/models/depth_face_model/encoder.pth')
    loaded_dict_dec = torch.load('depth/models/depth_face_model/depth.pth')
    ...
    source_image = imageio.v3.imread(opt.source_image)
